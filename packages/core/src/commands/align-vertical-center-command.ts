...
export class AlignVerticalCenterCommand extends Command {
  ...
  execute() {
    ...
    this.editor.alignManager.align(models, AlignDir.VERTICAL_CENTER);
  }

  getName() {
    return AlignVerticalCenterCommand.name;
  }
  ...
  static name = 'alignVerticalCenter';
}
